...
const IMPORTER_STEPS: OnboardingStep[] = [
  ...
  { title: "Collect the evidence", description: "Upload COAs, audit reports, food safety plans and certifications — or ask the exporter to submit them directly if they have an account.", cta: { label: "Go to Document Library", href: "/evidence" } },
  { title: "Review what they submit", description: "Accept, request revisions on, or reject each document. Only accepted evidence counts toward a record.", cta: { label: "Open Supplier Submissions", href: "/importer-review" } },
